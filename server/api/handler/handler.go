...
func (h *Handler) Register(s *server.Hertz) {
	...
	v1.GET("/runs/:id/work-graph", h.getRunWorkGraph)
	v1.PATCH("/runs/:id/nodes/:node", h.updateRunNode)
	v1.POST("/runs/:id/interrupts", h.createRunInterrupt)
	v1.PATCH("/interrupts/:id", h.resolveRunInterrupt)

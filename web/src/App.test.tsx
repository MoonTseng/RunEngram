...
describe("App workspace layout", () => {
  ...
  it("uses zh-CN labels when the browser locale is Chinese", () => {
  ...
  it("switches from zh-CN to English without reloading", async () => {
    ...
    await user.click(screen.getByRole("button", { name: "切换为 English" }));

...
function renderEditorInChinese() {
...
describe("TaskEditor markdown description editing", () => {
  ...
  it("shows the primary editor fields and actions in zh-CN", () => {
    renderEditorInChinese();

    expect(
      screen.getByRole("dialog", { name: `编辑任务 ${task.title}` })
    ).toBeTruthy();
    ...
    expect(screen.getByText("依赖任务")).toBeTruthy();

...
required_sections = {
    "skills/taskline-management/SKILL.md": [
        ...
        "### review → done",
        "## Fast path",
        "runengram task context <id>",
        "runengram task recall <id>",
        "runengram capsule create",
        "runengram capsule use",
        "--outcome used",
        "--outcome ignored",
        "--evidence-kind",
        "Never mark memory `helpful` merely because it was recalled",
        "runengram capsule edit",
        "runengram capsule relate",
        ...
        "runengram learning capture",
        "runengram learning promote",
        "runengram learning reject",
        ...
        "runengram run node <run-id>",
        "runengram run interrupt <run-id>",
        "Workflow Adapter",
    ],

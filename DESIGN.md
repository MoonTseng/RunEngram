...
# RunEngram Design System

## Overview

RunEngram's current web UI is a compact operational workspace for agents and
humans. It follows a Wabi-Sabi direction: quiet paper surfaces, ink-like text,
modest edges, muted natural accents, and enough empty space to make dense task
data legible without turning the app into a marketing page.
...
- Turn the operational workspace into a marketing page or hero layout.
